...
export default function TopBar({ filterAction, searchState }){
      ...
      <div className="flex justify-between items-center px-5 py-3 shadow-md gap-5">
        ...
        <div className="flex gap-2.5 items-center">
          ...
          <div className="flex gap-2.5 items-center bg-[#b8d3dd] rounded-2xl p-3">
            ...
            <input onChange={(e)=>setSearch(e.target.value)} value={search} className="bg-transparent outline-0" placeholder="বই বা শিট খুঁজুন" />
          </div>
